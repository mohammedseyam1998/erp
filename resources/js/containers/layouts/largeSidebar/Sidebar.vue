                    ...
                    <ul class="navigation-left">
                        <li :class="{ active: selectedParentMenu == 'dashboard' }" class="nav-item" data-item="dashboard">
                          ...
                          <li @mouseenter="toggleSubMenu" class="nav-item"
                            :class="{ active: selectedParentMenu == 'dataTable' }" data-item="dataTable">
                            <a class="nav-item-hold" href="#">
                                <i class="nav-icon i-Library"></i>
                                <span class="nav-text"> {{ $t('Data Table')}}</span>
                            </a>
                            <div class="triangle"></div>
                        </li>
                        <li @mouseenter="toggleSubMenu" class="nav-item"
                            ...
                            <div ref="sidebarChild">
                                ...
                                <ul
                                   ...
                                   <ul
                                    ...
                                    :class="{ 'd-block': selectedParentMenu == 'dataTable' }">
                                    <li class="nav-item">
                                        <router-link tag="a" class to="/newTable">
                                            <i class="nav-icon i-Windows-2"></i>
